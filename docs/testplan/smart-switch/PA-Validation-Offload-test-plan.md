...
The pa validation offload feature will support the validation for traffic of all directions(inbound and outbound), and the pa validation is done on the switch side.
